...
export function SignInForm() {
  ...
  return (
    <div className="space-y-4">
      <Button className="w-full" size="lg" disabled={busy} onClick={() => void run(signInWithGoogle)}>
      ...
      <div className="flex gap-2">
        <Button variant="outline" className="flex-1" disabled={busy} onClick={() => void run(() => signInWithPassword(email, password))}>
          Sign in
        </Button>
