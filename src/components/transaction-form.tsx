    ...
    <>
      {trigger === "header" ? (
        <button
          ...
          className="inline-flex h-11 w-full items-center justify-center gap-2 rounded-xl bg-primary px-5 font-semibold text-on-primary hover:opacity-90 sm:w-auto"
        >
